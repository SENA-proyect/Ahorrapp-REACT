// src/components/ModuloGastos.jsx
      ...
      <main>
        ...
        <nav className="navbar" aria-label="Menú de secciones">
          <ul className="nav-list">
            ...
            <li><Link to="/gastos" className="nav-link active">Gastos</Link></li>
        ...
        <section className="modulo-ahorros">
          ...
          <div className="resumen-container">
            <p className="total-ahorros">Total Gastos Mensuales: <strong>$0</strong></p>
            <p className="mensaje-vacio">No has registrado gastos hoy. Mantén tus cuentas claras agregando tus consumos.</p>
          </div>
        </section>
      </main>
