// src/components/ModuloCategorias.jsx
      ...
      <main>
        ...
        <nav className="navbar" aria-label="Menú de secciones">
          <ul className="nav-list">
            ...
            <li><Link to="/categorias" className="nav-link active">Categorias</Link></li>
          </ul>
        </nav>
        ...
        <section className="modulo-ahorros">
          <header className="modulo-header">
            ...
            <div className="acciones-ahorro">
              <button type="button" className="btn-secundario">Agregar categoria</button>
            </div>
          </header>

          <div className="resumen-container">
            <p className="total-ahorros">Total categorias: <strong>0</strong></p>

            <div className="tabla-ingresos" style={{ marginTop: '20px' }}>
              <p className="mensaje-vacio">No hay categorias registradas. Agrega tu primer categoria para comenzar.</p>
            </div>
          </div>
        </section>
      </main>
