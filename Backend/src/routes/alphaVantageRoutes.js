...
router.get('/bolsa/:symbol', async (req, res) => {
  ...
  console.log('DEBUG - API_KEY usada:', API_KEY)  // ← línea temporal de diagnóstico
  console.log('DEBUG - URL completa:', `https://finnhub.io/api/v1/quote?symbol=${symbol}&token=${API_KEY}`)  // ← línea temporal
