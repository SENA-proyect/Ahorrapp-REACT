// src/components/ModuloAhorros.jsx
      ...
      <main>
        ...
        <nav className="navbar" aria-label="Menú de secciones">
          <ul className="nav-list">
            ...
            <li><Link to="/ahorros" className="nav-link active">Ahorros</Link></li>
        ...
        <section className="modulo-ahorros">
          <header className="modulo-header">
            ...
            <div className="acciones-ahorro">
              <button type="button" className="btn-primario">Agregar dinero</button>
              <button type="button" className="btn-secundario">Nueva Meta</button>
            </div>
          </header>

          <div className="resumen-container">
            <p className="total-ahorros">Total Ahorros: <strong>$0</strong></p>
