...
const Imprevistos = () => {
  ...
  const abrirEditar = (i) => setModalEditar({
    id:          i.id,
    monto:       i.monto,
    causa:       i.causa || '',
        ...
        {modalEditar && (
          <div style={overlayStyle}>
            <div style={modalStyle}>
              <h4 style={{ marginBottom: '16px' }}>Editar Imprevisto</h4>

              <label style={labelStyle}>Causa</label>
              <input style={inputStyle} type="text" value={modalEditar.causa}
                onChange={e => setModalEditar({ ...modalEditar, causa: e.target.value })} />
        ...
        {confirmarId && (
          <div style={overlayStyle}>
            <div style={{ ...modalStyle, maxWidth: '360px' }}>
              <h4 style={{ marginBottom: '12px' }}>¿Eliminar imprevisto?</h4>
...
const btnEditar          = { padding: '4px 12px', borderRadius: '6px', border: '1px solid var(--imprevistos-dark, #e67e22)', background: 'transparent', color: 'var(--imprevistos-dark, #e67e22)', cursor: 'pointer', fontSize: '0.8rem' }
...
const btnGuardar         = { padding: '8px 18px', borderRadius: '6px', border: 'none', background: 'var(--imprevistos-dark, #e67e22)', color: '#fff', cursor: 'pointer', fontSize: '0.9rem' }
