...
export const ROUTE_PERMISSIONS = {
  ...
  '/PanelDependientes': [ROLES.ADMINISTRADOR, ROLES.SUPERUSUARIO],
  '/PanelHistorial': [ROLES.ADMINISTRADOR, ROLES.SUPERUSUARIO],
  '/PanelMovimientos': [ROLES.ADMINISTRADOR, ROLES.SUPERUSUARIO],
