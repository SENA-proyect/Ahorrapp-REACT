...
export default function FormImprevisto({ tipoFlujo, subtipo }) {
  ...
  const inputCls = 'w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-slate-800 outline-none transition focus:border-purple-500 focus:ring-2 focus:ring-purple-200'

  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      <h3 className="text-xl font-bold text-purple-700">Datos del imprevisto</h3>
      ...
      <div className="space-y-2">
        <label className="block text-sm font-semibold text-slate-700">Causa</label>
        <input
          className={inputCls}
          type="text"
          name="causa"
      ...
      <button
        type="submit"
        className="w-full rounded-xl bg-purple-600 px-5 py-3 font-semibold text-white shadow-md transition hover:bg-purple-700 disabled:cursor-not-allowed disabled:bg-purple-300"
        disabled={cargando}
      >
